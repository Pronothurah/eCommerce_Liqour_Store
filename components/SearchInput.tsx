  ...
  return (
    <form className="flex w-full justify-center" onSubmit={searchProducts}>
      <input
        ...
        className="bg-golden input input-bordered w-[70%] rounded-r-none outline-none focus:outline-none max-sm:w-full"
      />
      <button type="submit" className="btn bg-golden text-primary rounded-l-none rounded-r-xl hover:bg-crimson">
        Search
      </button>
