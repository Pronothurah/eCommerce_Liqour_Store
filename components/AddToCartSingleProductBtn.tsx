...
const AddToCartSingleProductBtn = ({ product, quantityCount } : SingleProductBtnProps) => {
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-gray-300 border-1 font-normal bg-crimson text-primary hover:bg-primary hover:text-white hover:border-primary hover:scale-110 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Add to cart
    </button>
  );
